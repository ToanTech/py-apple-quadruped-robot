...
<u>最新开源代码版本：PADOG V0.1.02 BETA 1 2020423</u>
...
2. 3D 打印 Github 中 "菠萝狗制造资料（3D模型、配件表）" 中的三维模型
3.  按照“菠萝狗制造资料（3D模型、配件表）”配齐电控元器件
4. 在“菠萝狗官方”文件夹中下载菠萝狗开源程序，导入PyBoard
5. 按照教程视频中的组装方法组装、调试、玩耍

<u>**如果你已经有基础**</u>

1. 3D 打印 Github 中 "菠萝狗制造资料（3D模型、配件表）" 中的三维模型

2.  按照“菠萝狗制造资料（3D模型、配件表）”配齐电控元器件
